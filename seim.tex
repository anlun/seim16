...
классической задачей, возникающей в контексте различных классов
языковых процессоров, например, сред разработки (IDE) и декомпиляторов.
Одним из подходов к решению данной задачи является
форматирование на основе \emph{синтаксических шаблонов},
которое позволяет задать форматер.
...
Целью данной работы является создание методики генерации декларативного форматера на основе грамматики языка в форме Бэкуса-Наура.
